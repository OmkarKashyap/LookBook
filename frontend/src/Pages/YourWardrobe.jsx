...
{pose && pose.keypoints && pose.keypoints.length > 0 && recommendedImages.length > 0 && (
  <img
    ...
    style={{
      position: 'absolute',
      top: `${pose.keypoints[5].position.y}px`, 
      left: `${pose.keypoints[5].position.x}px`, 
      width: `${pose.keypoints[6].position.x - pose.keypoints[5].position.x}px`, 
      height: `${pose.keypoints[8].position.y - pose.keypoints[5].position.y}px`, 
      zIndex: 100, 
      cursor: 'pointer', 
